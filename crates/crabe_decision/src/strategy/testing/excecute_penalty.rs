...
impl ExcecutePenalty {
    ...
    pub fn new(id: u8) -> Self {
        Self { id, decide_direction: rand::rng().random_range(-0.1..0.1), shoot_state: 0 }
...
impl Strategy for ExcecutePenalty {
    ...
    fn step(
        ...
        if self.shoot_state == 2 {
            ...
            action_wrapper.push(self.id, shoot(chosed, &ball, &target, world));
