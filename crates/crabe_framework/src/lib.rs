...
//! crates. The `constant` module contains constants that are common to multiple
//! CRAbE crates.
//!
...
/// architecture used in the CRAbE project. Components are building blocks that
/// perform a specific task or set of related tasks, and can be combined to form
/// a pipeline for processing robot soccer data. The current components include
/// an input component for receiving data, a filter component for processing and
/// filtering the data, a decision component for making game decisions, a tools
/// component for assisting in those decisions, a guard component for ensuring
/// safe operation, and an output component for sending commands to the robots.
///
